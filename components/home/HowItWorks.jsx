        ...
        <div className="space-y-10">
            <div className="space-y-5"> 
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-7 gap-5 md:px-10">
                    {whyUs.map((why) => (
                        <div key={why.id} className=" p-5 shadow-2xl border-t-4 border-[#270A63E5] relative">
                            <FaPlus className="absolute h-6 w-6 -top-3.5 -left-3.5 text-yellow-600 md:hidden" />
                            <p className="flex items-center justify-center">{why.icon}</p>
                            <p className="font-bold py-5 text-lg text-center">{why.title}</p>
                            <p className="text-center">{why.why}</p>
                        </div> 
                    ))}
               </div>
            </div>
...
const whyUs = [
    {
        ...
        why: "Provide your professional information, career goals and style preferences"
    },
    {
        id: 2,
        ...
        why: "Our AI generates a uniques banner and a compeling bio taloired to you"
    },
    {
        id: 3,
        ...
        why: "Review your new assets, download them and ipdate your profiles instantly"
    }
]
